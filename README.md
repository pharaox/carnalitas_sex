...
Even the name *Make Love* itself is not appropriate when demanding sex from a slave who is neither a lover nor an official consort. Historically such acts were often condemned by religion as adulterous or worse, and should have all sorts of consequences in the game, ranging from stress impact to piety loss and opinion loss with the victim. For this reason, the [Carnalitas Slavery Expansion](https://www.loverslab.com/files/file/21651-carnalitas-slavery-expansion/) mod introduces the *Demand Sex* interaction that partially addresses some of these points, adding however its own fanciful quirks, and not addressing the above issues so that slaves, while losing 20 opinion, are still acting in the sex scene as if enamoured with the player.
...
This mod and [Carnalitas Slavery Reimagined](https://www.loverslab.com/files/file/25565-carnalitas-slavery-reimagined/) have been designed to complement each other, but could be used independently as well.
...
* Either "consensual" or "dubcon" / "dominant player" Carnalitas [sex scene flags](#sex-scene-flags) are requested, depending on your relationship with the target, your mutual opinion, and how much you are attracted to each other. Additional Carnalitas sex scene flags such as "bdsm" may also be requested if specific conditions are fulfilled. Only  [sex scene events](#sex-scene-events) that support the requested flags may fire as a result.
...
Besides the fact that the Paradox sex scene generator may be available for "consensual" but not for "dubcon" scenes, there is no big difference between them. The new [sex scene generator](#sex-scene-generator) generates sex scenes depending on the [player and target attitudes](#player-and-target-attitudes), mostly disregarding if the scene is considered "consensual" or not.

For *Sadistic* characters targeting slaves or prostitutes (but not consorts or lovers) and if requesting "dubcon", the "bdsm" flag is also added. This flag is supported by one of the new sex scene events and the new sex scene generator.
...
* *Throes of Passion* (`carnx_sex_scene.0002`): Generic "consensual" scene using the [new sex scene generator](#sex-scene-generator).
* *Carnal Pleasures* (`carnx_sex_scene.0003`): Generic "dubcon" / "dominant player" scene using the new sex scene generator.
* *Twisted Pleasures* (`carnx_sex_scene.0005`): Generic "dubcon" / "dominant player" / "bdsm" scene using the new sex scene generator.
...
* Percy Bysshe Shelley, To Constantia, Singing, [Project Gutenberg](https://www.gutenberg.org/ebooks/4800)
...
* Tale of Kamar Al-Zaman, The Thousand Nights and a Night, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
* Casanova, The Memoirs of Jacques Casanova, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059), [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
* Giovanni Boccaccio, The Decameron, [Project Gutenberg](https://www.gutenberg.org/ebooks/3726)
* The Pike's Head, Kruptadia: Secret Stories from the Russian, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
* John and Joan, Merry Songs and Ballads, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
* The Husband As Doctor, Les Cent Nouvelles Nouvelles, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
* The Burning Yard, Kruptadia: Secret Stories from the Russian, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
* Take Time by the Forelock, Les Faceties de Pogge (Poggio) Florentin, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
* The Breaker of Eggs, Béroalde de Verville: Le Moyen de Parvenir, Anthologica Rarissima, [Project Gutenberg](https://www.gutenberg.org/ebooks/52059)
...
* John Cleland, Memoirs of Fanny Hill, [Project Gutenberg](https://www.gutenberg.org/ebooks/25305)
...
* [Character Body Overhaul](https://www.loverslab.com/files/file/16683-character-body-overhaul/). CBO has its own sex interactions that are not modified by this mod in any way.
